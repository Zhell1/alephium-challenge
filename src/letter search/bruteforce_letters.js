...
// tested up to 5 letters (included)
...
const letters = [...Array(26)].map((_, i) => String.fromCharCode(i + 97)); // Generates ['a', 'b', ..., 'z']
const minLength = 6; // Set your minimum length
const maxLength = 6; // Set your maximum length
